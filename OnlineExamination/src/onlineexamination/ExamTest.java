...
public class ExamTest extends JFrame implements ActionListener{
    
    String questions[][] = new String[10][5];
    String answers [][]= new String[10][2];
    String useranswers[][]= new String[10][1];
    JLabel qno,question,answer;
    JRadioButton opt1,opt2,opt3,opt4;
    ButtonGroup groupoption;
    JButton next,submit,stop;
...
//        
        ...
        add(opt4);
          ...
          answer = new JLabel();
        answer.setBounds(170,400,700,30);
        ...
        stop = new JButton("stop Exam");
        stop.setBounds(100,50,200,40);
        stop.setFont(new Font("Tahoma ",Font.PLAIN,22));
        stop.setBackground(new Color(30,144,255));
    ...
    public void paint(Graphics g)
    {
        ...
        if(timer>0)
        {
            g.drawString(time, 1100, 100);
              
        }else
        {
            g.drawString("Time up!", 1100, 100);
...
//         answer.setText("currect answer is : "+answers[count ][1]);
